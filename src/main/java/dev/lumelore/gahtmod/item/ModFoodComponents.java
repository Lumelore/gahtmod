...
public class ModFoodComponents {
    ...
    public static final FoodComponent ENBY_ITEM = (new FoodComponent.Builder()).alwaysEdible().nutrition(6).saturationModifier(0.1f)
    ...
    // Enby Power I for 24 minutes and Resistance II for 2 minutes -- Also fills players hunger quite a bit
    public static final FoodComponent STRONG_ENBY_ITEM = (new FoodComponent.Builder()).alwaysEdible().nutrition(12).saturationModifier(0.6f)
