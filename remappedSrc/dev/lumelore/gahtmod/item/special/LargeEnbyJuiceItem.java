...
public class LargeEnbyJuiceItem extends Item {

    public LargeEnbyJuiceItem(net.minecraft.item.Item.Settings settings) {
        super(settings);
    }
    ...
    public ItemStack finishUsing(ItemStack stack, World world, LivingEntity user) {
        ...
        if (stack.isEmpty()) {
            ItemStack tempStack = new ItemStack(Items.GLASS_BOTTLE);
            tempStack.setCount(3);
            return tempStack;
        }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, net.minecraft.item.Item.TooltipContext context) {
        tooltip.add(Text.translatable(ModEffects.ENBY_POWER.getTranslationKey()).formatted(ModEffects.ENBY_POWER.getCategory().getFormatting())
                .append(" (")
                .append(StatusEffectUtil.getDurationText(new StatusEffectInstance(ModEffects.ENBY_POWER, 28800), 1f, world == null ? 20.0f : world.getTickManager().getTickRate()))
                .append(")"));
        tooltip.add(Text.translatable(StatusEffects.RESISTANCE.getTranslationKey()).formatted(StatusEffects.RESISTANCE.getCategory().getFormatting())
                .append(" II (")
                .append(StatusEffectUtil.getDurationText(new StatusEffectInstance(StatusEffects.RESISTANCE, 2400), 1f, world == null ? 20.0f : world.getTickManager().getTickRate()))
                .append(")"));
